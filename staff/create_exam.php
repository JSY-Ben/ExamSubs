            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="mt-4 pb-4 border-bottom">
                    ...
                    <div class="form-text d-flex flex-wrap gap-2">
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-file-template" data-token="{exam_id}" data-bs-toggle="tooltip" data-bs-title="{exam_id}">Exam ID</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-file-template" data-token="{exam_title}" data-bs-toggle="tooltip" data-bs-title="{exam_title}">Exam Title</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-file-template" data-token="{student_firstname}" data-bs-toggle="tooltip" data-bs-title="{student_firstname}">Student First Name</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-file-template" data-token="{student_surname}" data-bs-toggle="tooltip" data-bs-title="{student_surname}">Student Surname</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-file-template" data-token="{student_firstname_initial}" data-bs-toggle="tooltip" data-bs-title="{student_firstname_initial}">Student First Initial</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-file-template" data-token="{student_surname_initial}" data-bs-toggle="tooltip" data-bs-title="{student_surname_initial}">Student Surname Initial</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-file-template" data-token="{candidate_number}" data-bs-toggle="tooltip" data-bs-title="{candidate_number}">Candidate Number</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-file-template" data-token="{document_title}" data-bs-toggle="tooltip" data-bs-title="{document_title}">Document Title</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-file-template" data-token="{original_name}" data-bs-toggle="tooltip" data-bs-title="{original_name}">Original Uploaded Filename</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-file-template" data-token="{submission_id}" data-bs-toggle="tooltip" data-bs-title="{submission_id}">Submission ID</button>
                    </div>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <div class="form-text d-flex flex-wrap gap-2">
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-folder-template" data-token="{exam_id}" data-bs-toggle="tooltip" data-bs-title="{exam_id}">Exam ID</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-folder-template" data-token="{exam_title}" data-bs-toggle="tooltip" data-bs-title="{exam_title}">Exam Title</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-folder-template" data-token="{student_firstname}" data-bs-toggle="tooltip" data-bs-title="{student_firstname}">Student First Name</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-folder-template" data-token="{student_surname}" data-bs-toggle="tooltip" data-bs-title="{student_surname}">Student Surname</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-folder-template" data-token="{student_firstname_initial}" data-bs-toggle="tooltip" data-bs-title="{student_firstname_initial}">Student First Initial</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-folder-template" data-token="{student_surname_initial}" data-bs-toggle="tooltip" data-bs-title="{student_surname_initial}">Student Surname Initial</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-folder-template" data-token="{candidate_number}" data-bs-toggle="tooltip" data-bs-title="{candidate_number}">Candidate Number</button>
                        <button class="btn btn-outline-secondary btn-sm token-btn" type="button" data-target="create-folder-template" data-token="{submission_id}" data-bs-toggle="tooltip" data-bs-title="{submission_id}">Submission ID</button>
                    </div>
                </div>
